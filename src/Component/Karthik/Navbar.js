      ...
      return(
          <div className="Navbar">
           ...
           <div className="nav-pic">
               <img src={nav1} className="nav1" style={{marginTop:"225px",left:"0", width:"1575px",height:"350px"}} alt=""></img>
           </div>
           <div className="nav-content">
               <img src={nav2} className="nav2" style={{marginTop:"700px", width:"350px",height:"250px"}} alt=""></img>
               <img src={nav3} className="nav2" style={{marginTop:"80%", width:"570px",height:"250px",left:"125px"}} alt=""></img>
           ...
           <div className="nav-par" >
               ...
               <p style={{marginTop:"80%"}}> <strong style={{fontSize:"30px",fontWeight:"bolder",color:"#1597bb"}}>About Us</strong><br/> <br/>Hinduja Housing Finance (HHF) is a part of the prestigious Hinduja Group, Registered 
